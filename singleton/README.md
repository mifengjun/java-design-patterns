...
![单例模式结构类图 https://lvgocc.github.io](../images/singleton/singleton.jpg)
...
　　对于单例模式的实现，本身的实现方法有很多中，也看到大家的思维很活跃。但我脑子也不好使。我只想解决一些根本问题，所以每种方法我们都讨论一下。🤣
...
《Effective Java》、Effective 系列图书作者。同时我们每天都在使用者他写的代码，集合框架，它们的位置位于``java.util.*``。
