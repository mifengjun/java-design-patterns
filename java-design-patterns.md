...
首先很高兴你能来阅读我写的《和 lvgo 一起学习设计模式》，下面的内容是希望在读之前也让你能对我有一点点了解。
...
我见到写的有错误的文章，我会及时指出，因为我不想因此误导别人，哪怕只是一个人在看。

但事实上并非所有作者都愿意一起坐下来与你讨论，我指出过一些公众号文章的问题，不过结果并不理想，以至于自己格格不入。

可能大部分写公众号的人都想着流量变现呢吧。可能有些写文章只是就是为了“凑”点阅读量吃饭而已，这是现实，我认。不过我更喜欢那些认认真真凑点击量吃饭的大佬。

## 道德制高点

可能有人看过格格不入之后的内容就觉得我站在了道德制高点，首先我觉得我能想到这就达不到这，人非圣人，孰能无过。水至清则无鱼，不仅你懂，我也懂，大宋的皇帝更懂（这里要看完《大宋提刑官》第一部全集才行）。

# 写在前面

## 声明

除设计模式背景或概念性内容外，其余全部内容均为自己深入理解消化各位前辈内容原创输出，我不知道这算不算原创，如果不算的话，那真正的原创在技术领域真的不好实现。
...
如果是，我相信这里很适合你阅读学习。设计模式学了不会用？可以看两篇试一试，同样的知识，不一样的“味道”。每一篇都有对应的文章配合源码学习，文章通俗易懂。以学渣的姿态来学习学霸的知识，我不善搞深奥的东西，但喜欢将深奥的东西变成简单的东西，我深信复杂度守恒定律，我也相信讲出来的东西是为了让大家能听懂而不是自己秀知识储备而已。听懂掌声。
...
- [x] [11. 解释器（Interpreter）模式：提供如何定义语言的文法，以及对语言句子的解释方法，即解释器。](https://github.com/lvgocc/java-design-patterns/tree/main/interpreter)
